import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as r,c as p,a as e,b as n,d as s,w as l,e as o}from"./app-456cb019.js";const u={},v={href:"https://github.com/hakimel/reveal.js/wiki/Plugins,-Tools-and-Hardware",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/vuepress-theme-hope/vuepress-theme-hope/issues/new?assignees=Mister-Hope&labels=enhancement&template=feature_request.md&title=%5BFeature+Request%5D",target:"_blank",rel:"noopener noreferrer"},k=o(`<p>你可以在客户端配置文件中导入并使用 <code>defineRevealConfig</code> 来自定义 reveal.js 的配置:</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// .vuepress/client.ts</span>
