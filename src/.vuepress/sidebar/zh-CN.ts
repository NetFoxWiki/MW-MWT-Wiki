				...
				children: [
					{
						...
						collapsible: true,
						children: [
							'zh/mw/collection/balance-log/mw80.md',
							'zh/mw/collection/balance-log/mw79.md',
							'zh/mw/collection/balance-log/mw78.md',
							'zh/mw/collection/balance-log/mw77.md',
							'zh/mw/collection/balance-log/mw70.md',
							'zh/mw/collection/balance-log/mw68.md',
						],
					},
					{
						text: '游戏赛事区',
						...
						collapsible: true,
						children: [
							'zh/mw/collection/tournament/ct.md',
							'zh/mw/collection/tournament/ctto.md',
							'zh/mw/collection/tournament/cn.md',
						],
					},
