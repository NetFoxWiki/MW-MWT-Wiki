...
export default hopeTheme({
  ...
  breadcrumb: false,
  pageInfo: ["Word", "ReadingTime", "PageView"],
  ...
  plugins: {
      ...
      rootComponents: {
        notice: [
          /*2023年9月21日
          {
                path: "/",
                title: "特殊公告",
                content: 'MWdocs 祝贺 西雅图 拿了英雄没传奇一周年',
                actions: [
                  {
                    text: "祝贺",
                    type: "primary",
              ...
              },*/
          {
            path: "/",
            title: "初来乍到！欢迎你，舰长！",
            content: '<font color="#2196F3">查看以下几步，即可访问网站：</font><br><br><font color="#fb8b05">1. </font><font color="#144a74">访问网站请同意声明</font><br><font color="#fb8b05">内容：</font>我是个现（现代战舰）批<hr><font color="#fb8b05" >2. </font><font color="#144a74" >我会积极维护评论区环境</font><hr><font color="#fb8b05" >3. </font><font color="#144a74" >MWdocs 衍生项目</font><br><font color="#fb8b05">MWwiki：</font><font color="#2196F3">wiki.mwdocs.info</font><br><font color="#fb8b05">地球:OL：</font><font color="#2196F3">earthol.mwdocs.info</font><br><font color="#fb8b05">现代战舰，启动！：</font><font color="#2196F3">mwdocs.info/mp.html</font><hr><font color="#fb8b05" >4. </font><font color="#144a74">此外，我们希望您可以从浏览器访问网站，避免网站被拦截</font>',
            actions: [
              {
                text: "同意",
                type: "primary",
    ...
    comment: {
      ...
      */
      provider: "Waline",
      serverURL: "https://waline.sever.mwdocs.info",
      meta: ['nick', 'mail'],
      requiredMeta: ['nick'],
      login: 'enable',
      PageView: true,
      ...
      pageSize: '50',
      imageUploader: false,
      turnstileKey: "0x4AAAAAAAIdPGuhewqPBLT3",
